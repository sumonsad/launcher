...
if(site_url()=="http://localhost/projecthasin"){
  ...
  function launcher_assets(){
    ...
    if($launcher_page_template=="launcher.php"){
        ...
        wp_enqueue_script("easing-jquery-js",get_theme_file_uri("/assets/js/jquery.easing.1.3.js"),array("jquery"),time(),true);
        wp_enqueue_script("bootstrap-min-js",get_theme_file_uri("/assets/js/bootstrap.min.js"),array("jquery"),time(),true);
        wp_enqueue_script("waypoints-min-js",get_theme_file_uri("/assets/js/jquery.waypoints.min.js"),array("jquery"),time(),true);
        wp_enqueue_script("simplyCountdown-js",get_theme_file_uri("/assets/js/simplyCountdown.js"),array("jquery"),time(),true);
  ...
  function launcher_sidebars(){
    register_sidebar(
      array(
          'id'            => 'footer-leftside',
          'name'          => __('Footer Leftside', 'launcher' ),
          'description'   => __('Footer Leftside','launcher' ),
  ...
  register_sidebar(
      array(
          'id'            => 'footer-rightside',
          'name'          => __( 'Footer Rightside', 'launcher' ),
          'description'   => __( 'Footer Rightside','launcher' ),
